...
news['type'].replace(['conspiracy', 'junksci', 'rumor', 'hate', 'unreliable', 'clickbait', 'satire', 'fake','bias'], 0, inplace = True)
#delete 'unknown'
news = news.drop(news[news['type']=='unknown'].index)
...
print("svc accuracy:" + str(accuracy_score(y_val,svc_pred)))
...
# %%
'''
SVC accuracy:0.8350329934013198
Nearest Neighbors  score: 0.6942446043165468
Random Forest  score: 0.6894484412470024
Neural Net  score: 0.7667865707434053
LogReg  score: 0.8039568345323741
'''
